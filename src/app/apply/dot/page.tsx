...
const questions = [
  ...
  { id: "why_dot", label: "De ce vrei să faci parte din DOT?", type: "textarea", required: true },
  { id: "scenario1", label: "Scenariu: Un drum este blocat de un accident. Ce faci?", type: "textarea", required: true },
...
export default function DOTApplication() {
  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen pt-24 pb-12 px-4 relative overflow-hidden">
        <FloatingElements count={6} colors={["#f59e0b", "#d97706", "#fbbf24"]} />
        <div className="max-w-2xl mx-auto relative z-10">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button className="bg-gradient-to-r from-yellow-500 to-amber-500">
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4 relative">
      <FloatingElements count={5} colors={["#f59e0b", "#d97706"]} />
      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        >
          ...
          <TiltCard tiltAmount={3} glowColor="rgba(245, 158, 11, 0.2)">
            <div className="p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
              <div className="text-center mb-8">
                <motion.div
                  className="w-20 h-20 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-yellow-500 to-amber-500 flex items-center justify-center"
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  transition={{ type: "spring", stiffness: 300 }}
                >
                  <Truck className="w-10 h-10 text-white" />
                </motion.div>
                <h1 className="text-3xl font-bold text-white mb-2">Aplică pentru DOT</h1>
                <p className="text-white/60">
                  Completează formularul de mai jos pentru a aplica în Departamentul de Transport (DOT)
                </p>
              </div>
              ...
              >
                  ...
                  <motion.div key={q.id} variants={itemVariants}>
                    ...
                    {q.type === "textarea" ? (
                      <Textarea
                        ...
                        className="bg-white/5 border-white/10 text-white placeholder:text-white/40 min-h-[100px] focus:border-yellow-500/50 focus:ring-yellow-500/20 transition-all"
                        required={q.required}
                      />
                    ) : (
                      <Input
                        ...
                        value={formData[q.id] || ""}
                        onChange={(e) => handleChange(q.id, e.target.value)}
                        className="bg-white/5 border-white/10 text-white placeholder:text-white/40 focus:border-yellow-500/50 focus:ring-yellow-500/20 transition-all"
                        required={q.required}
                      />
                    )}
                  </motion.div>
                ...
                <motion.div variants={itemVariants}>
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-600 hover:to-amber-600 text-white py-6 relative overflow-hidden group"
                  >
                    <motion.div
